...

{
  grafanaDashboards+:: {
    'snowflake-overview.json':
      ...
      .addPanels(
        [
          warehouseActivityPanel { gridPos: { h: 9, w: 24, x: 0, y: 0 } },
          accountStorageUsagePanel { gridPos: { h: 8, w: 24, x: 0, y: 9 } },
          loginAttemptsPanel { gridPos: { h: 8, w: 12, x: 0, y: 17 } },
          successfulLoginAttemptsPanel { gridPos: { h: 8, w: 6, x: 12, y: 17 } },
          failedLoginAttemptsPanel { gridPos: { h: 8, w: 6, x: 18, y: 17 } },
          billingRow { gridPos: { h: 1, w: 24, x: 0, y: 25 } },
          averageHourlyCreditsUsedPanel { gridPos: { h: 8, w: 24, x: 0, y: 26 } },
          top5ServiceComputeCreditsUsedPanel { gridPos: { h: 8, w: 12, x: 0, y: 34 } },
          top5ServiceCloudServiceCreditsUsedPanel { gridPos: { h: 8, w: 12, x: 12, y: 34 } },
          top5WarehouseComputeCreditsUsedPanel { gridPos: { h: 8, w: 12, x: 0, y: 42 } },
          top5WarehouseCloudServicesCreditsUsedPanel { gridPos: { h: 8, w: 12, x: 12, y: 42 } },
          autoclusteringCreditsUsedPanel { gridPos: { h: 9, w: 24, x: 0, y: 50 } },
          top5TableAutoclusteringCreditsUsedPanel { gridPos: { h: 8, w: 12, x: 0, y: 59 } },
          top5DatabaseAutoclusteringCreditsUsedPanel { gridPos: { h: 8, w: 12, x: 12, y: 59 } },
        ]
      ),
  },
}
